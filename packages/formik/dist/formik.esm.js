...
function useFormik(_ref) {
  ...
  var applyFieldValue = useCallback(function (field, value, shouldValidate, isTouched) {
  ...
  useEffect(function () {
    registerField(name, {
      validate: function validate(value) {
        if (_validate) return _validate(value, formik.values);
      }
    });
    return function () {
      unregisterField(name);
